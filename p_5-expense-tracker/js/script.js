...
function createTransactionElement(transaction){
    ...
    <span>${formatCurrancy(transaction.amount)}
...
function updateSummary(){
    const balance = transactions.reduce((accu , transaction) => accu + transaction.amount,0);
    ...
    expenseAmountEl.textContent = formatCurrancy(expenses);
}
